...
**496,975** residential properties and condos: **1,135** flagged
as likely over-assessed, **7,267** as likely under-assessed, and
**44,799** unflagged but at or beyond the edge of the published
range ("worth a look").
...
Out-of-time test set (n = 19,484), run `20260707T030251Z-baseline`. The same
...
| --- | --- | --- | --- | --- | --- |
| This model | 1.004 | 18.6 | 1.021 | +0.007 | 18.7% |
...
|  | Median ratio | COD | PRD | PRB | MAPE |
| --- | --- | --- | --- | --- | --- |
| This model | 1.037 | 24.9 | 1.086 | -0.084 | 26.0% |
