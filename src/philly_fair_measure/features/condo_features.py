...
def assemble_condo_features(
    ...
    *,
    ...
    from philly_fair_measure.features.sale_features import _parcel_prior_sale_features
    ...
    from philly_fair_measure.features.market_areas import project_xy
    from philly_fair_measure.features.spatial import knn_ppsf_for_sales
    ...
    from philly_fair_measure.features.sale_features import join_proximity
...
def assemble_condo_assessment_features(
    ...
    from philly_fair_measure.features.market_areas import project_xy
    from philly_fair_measure.features.spatial import knn_ppsf_at_date
