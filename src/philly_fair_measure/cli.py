...
def _cmd_snapshot(args: argparse.Namespace) -> int:
    if args.source == "arcgis":
        ...
        from philly_fair_measure.sources.arcgis import SEPTA_ARCGIS_BASE
...
def _cmd_stage(args: argparse.Namespace) -> int:
    from philly_fair_measure.staging import build_all
...
def _cmd_validate_sales(args: argparse.Namespace) -> int:
    from philly_fair_measure.validation import build_sale_validity
...
def _cmd_build_features(args: argparse.Namespace) -> int:
    from philly_fair_measure.features import build_sale_features
...
def _cmd_train_condo(args: argparse.Namespace) -> int:
    from philly_fair_measure.models.condo import train_condo
...
def _cmd_train_bayesian(args: argparse.Namespace) -> int:
    from philly_fair_measure.models.bayesian import train_bayesian
...
def _cmd_build_market_areas(args: argparse.Namespace) -> int:
    from philly_fair_measure.features.market_areas import build_market_areas
...
def _cmd_build_price_index(args: argparse.Namespace) -> int:
    from philly_fair_measure.features.price_index import build_price_index
...
def _cmd_build_proximity(args: argparse.Namespace) -> int:
    from philly_fair_measure.features.proximity import build_proximity
...
def _cmd_screen_assessments(args: argparse.Namespace) -> int:
    from philly_fair_measure.validation.opa import build_assessment_screen
...
def _cmd_conformal_check(args: argparse.Namespace) -> int:
    ...
    from philly_fair_measure.models.conformal import conformal_check
...
def _cmd_acs_sensitivity(args: argparse.Namespace) -> int:
    ...
    from philly_fair_measure.diagnostics.acs_sensitivity import run_acs_sensitivity
...
def _cmd_retail_market(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.retail_market import retail_vs_blend
...
def _cmd_fairness_robustness(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.fairness_robustness import fairness_robustness
...
def _cmd_regressivity_cv(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.fairness_robustness import vertical_regressivity_cv
...
def _cmd_stability_audit(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.stability import (
...
def _cmd_robustness_audit(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.robustness import robustness_audit
...
def _cmd_channel_decomp(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.channel import channel_decomposition
...
def _cmd_ratio_study(args: argparse.Namespace) -> int:
    ...
    from philly_fair_measure.diagnostics.ratio_study import iaao_bridge, sale_chasing_check
...
def _cmd_aerial_score(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.aerial_change import run_aerial_score
...
def _cmd_facade_coverage(args: argparse.Namespace) -> int:
    from philly_fair_measure.diagnostics.facade import coverage_summary, facade_coverage
...
def _cmd_report(args: argparse.Namespace) -> int:
    from philly_fair_measure.report import build_property_report
...
def _cmd_leaderboard(args: argparse.Namespace) -> int:
    from philly_fair_measure.report import build_property_report, leaderboards
...
def _cmd_freshness(args: argparse.Namespace) -> int:
    ...
    from philly_fair_measure import config
    from philly_fair_measure.ingest.snapshots import FETCHED_AT_FORMAT
