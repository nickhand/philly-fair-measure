...
if TYPE_CHECKING:
    from philly_fair_measure.models.metrics import Metrics
...
def mechanism_demo(data_dir: Path | None = None) -> pl.DataFrame:
    ...
    from philly_fair_measure.diagnostics.stability import _fit_predict
    from philly_fair_measure.models.baseline import _load_frame, feature_lists
